...
class Paging {
	constructor(props) {
		if(props) {
			this.currentPaging=props.totalCount;
			this.totoalCount=props.totalCount;
		}
	}
	getPaging() {
	...
	backward() {
		...
		if(this.currentPaging<this.totoalCount) this.currentPaging=this.currentPaging*TOURNAMENT_STEP;
	}
}
